...
const GetEmail = ({
  ...
  const onFinish = async (values) => {
    ...
    values['loanType'] = 'RefiOrPurchase';
    values['applicationStep'] = '/refi-pages/tellUsAboutYourself/';
    values['primaryResidence'] = JSON.parse(
      localStorage.getItem('primaryResidence')
    );
    ...
    values['propertyAddress'] = JSON.parse(
      localStorage.getItem('propertyAddress')
    );
    values['apartmentNumber'] = JSON.parse(
      localStorage.getItem('apartmentNumber')
    );
    values['city'] = JSON.parse(localStorage.getItem('city'));
    values['state'] = JSON.parse(localStorage.getItem('state'));
    values['zipCode'] = JSON.parse(localStorage.getItem('zipCode'));
