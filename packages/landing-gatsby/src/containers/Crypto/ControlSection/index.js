      ...
      <Container>
        <Box className="row" {...row}>
          ...
          <Box className="colright" {...col} {...cardArea}>
            <Text
              content="Effortless loans for everyone."
              {...sectionSubTitle}
            />
            <FeatureBlock
              title={
                <Heading
                  content="Take control of your finances."
                  {...title}
                />
              }
              description={
                <Text
                  content="Juno makes lending effortless and automated, so now you can get your money in days, not months."
                  {...description}
                />
              }
            />
