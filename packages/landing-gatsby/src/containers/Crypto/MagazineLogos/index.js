...
import Forbes from 'common/src/assets/image/crypto/forbes.png';
import techCrunch from 'common/src/assets/image/crypto/techCrunch.png';
import wallStreetJournal from 'common/src/assets/image/crypto/wallStreetJournal.png';
import newYorkTimes from 'common/src/assets/image/crypto/newYorkTimes.jpg';
import yahooFinance from 'common/src/assets/image/crypto/yahooFinance.png';
    ...
    <TransactionsWrapper id="transactions">
      <Container className="containerClass">
        ...
        >
          ...
          <Image src={Forbes} width="190" height="64" />
          <Image src={techCrunch} width="140" height="140" />
          <Image src={wallStreetJournal} width="80" height="80" />
          <Image src={newYorkTimes} width="90" height="90" />
          <Image src={yahooFinance} width="200" height="130" />
          {/*  </Box> */}
          {/*  <Box
            className="colright"
            {...col}
