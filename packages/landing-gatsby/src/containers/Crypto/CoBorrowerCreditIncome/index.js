...
const IncomeCoBorrowerComponent = ({
  sectionWrapper,
  row,
  contactForm,
  secTitleWrapper,
  ...
  const onFinish = async () => {
	 ...
	 if(Bonus) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: Bonus,
			employmentIncomeIndicator: "true", //"true" "false"
			incomeType: "Bonus",
		})
	 } 
	 ...
	 if(SelfEmploymentIncome) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: SelfEmploymentIncome,
	 ...
	 if(PayMyselfEmploymentIncome) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: PayMyselfEmploymentIncome,
			employmentIncomeIndicator: "false", //"true" "false"
			incomeType: "Base",
		})
	 } 
	 if(SocialSecurity) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: SocialSecurity,
			employmentIncomeIndicator: "true", //"true" "false"
	 ...
	 if(ChildSupport) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: ChildSupport,
			employmentIncomeIndicator: "true", //"true" "false"
	 ...
	 if(Alimony) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: Alimony,
			employmentIncomeIndicator: "true", //"true" "false"
			incomeType: "Alimony",
		})
	 } 
	 if(Other) {
		incomeTypeArray.push({
			currentIncomeMonthlyTotalAmount: Other,
			employmentIncomeIndicator: "true", //"true" "false"
			incomeType: "Other",
		})
	 } 
	  
	currentUser.coBorrower.income = incomeTypeArray 
			...
			<Form.Item
				...
				{showSelfEmploymentTextBox && showIssueMyselfPayTextBox && (
                  ...
                  >
                    ...
                    >
                      <b>Social security, pension, or disability</b>
                    </Checkbox>
                  </Form.Item>
				...
				{showOtherTextBox && (
 				...
 				<Form.Item
                  ...
                  >
                    ...
                    >
                      <b>Not currently earning money</b>
                    </Checkbox>
                  </Form.Item>
...
IncomeCoBorrowerComponent.propTypes = {
...
IncomeCoBorrowerComponent.defaultProps = {
  sectionWrapper: {
    id: 'contact_section',
    as: 'section',
...
const CreditIncomeCoBorrowerComponentRedux = connect(
  mapStateToProps,
  mapDispatchToProps
)(IncomeCoBorrowerComponent);

export default CreditIncomeCoBorrowerComponentRedux;
