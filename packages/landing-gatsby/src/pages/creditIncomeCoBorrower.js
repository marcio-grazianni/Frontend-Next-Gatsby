...
import CreditIncomeCoBorrowerComponentRedux from '../containers/Crypto/CoBorrowerCreditIncome';
import Button from 'common/src/components/Button';
import Footer from '../containers/Crypto/Footer';

const CreditIncomeAssetsCoBorrower = () => {
  return (
      ...
      <Provider store={store}>
        <Fragment>
          ...
          <ContentWrapper>
            ...
            <CreditIncomeCoBorrowerComponentRedux />
            <Footer />
          </ContentWrapper>
        </Fragment>
      </Provider>
...
export default CreditIncomeAssetsCoBorrower;
