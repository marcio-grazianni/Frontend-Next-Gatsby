...
import ResidencyMarriageRedux from '../../containers/Crypto/RefiComponents/RefiResidencyMarriage/';

const ResidencyMarriagePage = () => {
  return (
...
export default ResidencyMarriagePage;
