...
import HowLongCurrentAddressSectionRedux from '../../containers/Crypto/RefiComponents/HowLongCurrentAddress';

const HowLongCurrentAddress = () => {
  return (
      ...
      <Provider store={store}>
        <Fragment>
          ...
          <ContentWrapper>
            ...
            <HowLongCurrentAddressSectionRedux />
          </ContentWrapper>
        </Fragment>
      </Provider>
    </ThemeProvider>
...
export default HowLongCurrentAddress;
