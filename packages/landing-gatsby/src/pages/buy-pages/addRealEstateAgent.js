...
import AddRealEstateAgentComponentRedux from '../../containers/Crypto/BuyComponents/AddRealEstateAgent';
import Button from 'common/src/components/Button';
import Footer from '../../containers/Crypto/Footer';

const AddRealEstateAgent = () => {
  return (
      ...
      <Provider store={store}>
        <Fragment>
          ...
          <ContentWrapper>
            ...
            <AddRealEstateAgentComponentRedux />
            <Footer />
          </ContentWrapper>
        </Fragment>
      </Provider>
...
export default AddRealEstateAgent;
