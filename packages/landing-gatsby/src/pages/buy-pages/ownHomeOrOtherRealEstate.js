...
import OwnHomeOrOtherRealEstateComponentRedux from '../../containers/Crypto/BuyComponents/OwnHomeOrOtherRealEstate';
import Footer from '../../containers/Crypto/Footer';

const OwnHomeOrOtherRealEstate = () => {
  return (
      ...
      <Provider store={store}>
        <Fragment>
          ...
          <ContentWrapper>
            ...
            <OwnHomeOrOtherRealEstateComponentRedux />
            <Footer />
          </ContentWrapper>
        </Fragment>
      </Provider>
...
export default OwnHomeOrOtherRealEstate;
