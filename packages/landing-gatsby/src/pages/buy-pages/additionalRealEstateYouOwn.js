...
import AdditionalRealEstateYouOwnComponentRedux from '../../containers/Crypto/BuyComponents/AdditionalRealEstateYouOwnComponent';
import Footer from '../../containers/Crypto/Footer';

const AdditionalRealEstateYouOwn = () => {
  return (
      ...
      <Provider store={store}>
        <Fragment>
          ...
          <ContentWrapper>
            ...
            <AdditionalRealEstateYouOwnComponentRedux />
            <Footer />
          </ContentWrapper>
        </Fragment>
      </Provider>
...
export default AdditionalRealEstateYouOwn;
