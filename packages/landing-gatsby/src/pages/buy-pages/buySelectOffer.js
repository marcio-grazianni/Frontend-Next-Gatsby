...
import PageWithNavBarStylingWrapper from '../../containers/Crypto/pageStylingWithNavbar.style';
        ...
        <Fragment>
          ...
          <ContentWrapper>
            <Sticky top={0} innerZ={9999} activeClass="sticky-nav-active">
              <DrawerProvider>
                <NavbarNoHamburger style={{ marginLeft: '270px' }} />
              </DrawerProvider>
              <SideNavBar />
            </Sticky>
            {/* <BannerSectionNoWords /> */}
            {/* <div style={{paddingLeft: '270px'}}> */}
            <PageWithNavBarStylingWrapper class="componentWithNavbar">
              <SelectOfferContainerRedux class="componentWithNavbar" />
              <Footer />
            </PageWithNavBarStylingWrapper>
            {/* </div> */}
          </ContentWrapper>
        </Fragment>
      </Provider>
