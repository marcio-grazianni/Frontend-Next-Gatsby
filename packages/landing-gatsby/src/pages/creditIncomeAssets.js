...
import CreditIncomeAssetsComponentRedux from '../containers/Crypto/CreditIncomeAssets';
import Button from 'common/src/components/Button';
import Footer from '../containers/Crypto/Footer';

const CreditIncomeAssets = () => {
  return (
      ...
      <Provider store={store}>
        <Fragment>
          ...
          <ContentWrapper>
            ...
            <CreditIncomeAssetsComponentRedux />
            <Footer />
          </ContentWrapper>
        </Fragment>
      </Provider>
...
export default CreditIncomeAssets;
